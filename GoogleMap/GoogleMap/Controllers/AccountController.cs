    ...
    public class AccountController:Controller
    {
        ...
        public async Task<IActionResult> Register()
        {
            ...
            else
            {
                ...
                model.SiteName = (await this.siteConfigService.GetConfigAsync<SiteConfig>()).SiteName;
        ...
        public async Task<IActionResult> Login(string returnUrl = "")
        {
            ...
            {
                SiteConfig config = await this.siteConfigService.GetConfigAsync<SiteConfig>();
